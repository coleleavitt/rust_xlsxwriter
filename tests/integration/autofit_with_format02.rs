...
fn create_new_xlsx_file_standard(filename: &str) -> Result<(), XlsxError> {
    ...
    worksheet.set_row_format(0, &format1)?;
...
#[test]
fn test_autofit_with_format02_standard() {
    let test_runner = common::TestRunner::new()
        .set_name("autofit_with_format02")
...
#[test]
fn test_autofit_with_format02_standalone() {
    let test_runner = common::TestRunner::new()
        .set_name("autofit_with_format02")
...
#[test]
#[cfg(feature = "constant_memory")]
fn test_autofit_with_format02_constant_memory() {
    let test_runner = common::TestRunner::new()
        .set_name("autofit_with_format02")
